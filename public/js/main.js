...
// // referencing firestore test
// let userRef = firestore.collection('StudentDetails').get().then(items=> console.log(items.doc));
// firestore.collection('StudentScanClass').get()
// .then(res => {
//   // vm.mainListItems = [];
//   let sam = "tQYYT9Q3CATNMV5psgoslhDnUsl1";
//   res.forEach(doc => {
...
//       newItem.sam.get()
//       .then(res => { 
//         newItem.Studentid = res.data() 
//         // vm.mainListItems.push(newItem);
//         console.log("combination", res.data());
//       })
//       .catch(err => console.error(err));
//     } else {
//       console.log("you are fucked up",doc.id);
//       // vm.mainListItems.push(newItem);  
//     }
...
// // runing individual test
// let StudRef = firestore.collection('StudentDetails').get().then(doc => {
//   console.log("majaribu",doc.data());
// });


// // setting reference
// let data = { name: 'productName', size: 'medium' }
// data.userRef = db.doc('users/' + firebase.auth().currentUser.uid);  will get user id
// db.collection('products').add(data);  will save the new data
// // setting data from related references
...
// let scandata = firestore.collection('StudentScanClass').get();
// console.log("scans in general:", scandata.doc.data());

// firestore.collection("StudentDetails").get().then(querySnapshot => console.log(doc.id, " => ", querySnapshot.doc.data()));





// simple attendance test with dummy data
firestore.collection("StudentScanClass").where("semester", "==", "2").where("year","==", "2018").where("querydate","==","2018-11-11")
    .get()
    .then(function(querySnapshot) {
        querySnapshot.forEach(function(doc) {
            // doc.data() is never undefined for query doc snapshots
